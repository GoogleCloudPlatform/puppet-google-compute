...
#       puppet apply .tools/end2end/data/vpn_tunnel.pp
#
...
gcompute_target_vpn_gateway { "puppet-e2e-my-gateway-${gateway_id}":
  project     => $project,
  credential  => 'mycred',
  network     => "puppet-e2e-mynetwork-${network_id}"}

gcompute_vpn_tunnel { "puppet-e2e-my-tunnel-${gateway_id}":
  project     => $project,
  credential  => 'mycred',
  target_vpn_gateway => "puppet-e2e-my-gateway-${network_id}"}
