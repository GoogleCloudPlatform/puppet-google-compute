  ...
  module Compute
    module Data
      ...
      class AddressAddressRefCatalog < AddressAddressRef
        ...
        def resource
          Google::ObjectStore.instance[:gcompute_address].each do |entry|
            return entry.exports[:address] if entry.title == @title
          end
    ...
    module Property
      ...
      class AddressAddressRef < Puppet::Property
        ...
        def self.unsafe_munge(value, resource = nil)
          return if value.nil?
          Data::AddressAddressRefCatalog.new(value, resource)
        end
