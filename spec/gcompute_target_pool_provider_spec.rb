...
describe Puppet::Type.type(:gcompute_target_pool).provider(:google) do
  before(:all) do
          ...
          context 'title == name (pass)' do
            ...
            let(:catalog) do
              apply_with_error_check(
                ...
                gcompute_instance { 'resource(instance,0)':
                  ensure     => present,
                  name       => 'test name#0 data',
                ...
                gcompute_instance { 'resource(instance,1)':
                  ensure     => present,
                  name       => 'test name#1 data',
                ...
                gcompute_instance { 'resource(instance,2)':
                  ensure     => present,
                  name       => 'test name#2 data',
            ...
            context 'Gcompute_target_pool[title0]' do
              subject do
                catalog.resource('Gcompute_target_pool[title0]').provider
              end
            ...
            context 'Gcompute_target_pool[title1]' do
              subject do
                catalog.resource('Gcompute_target_pool[title1]').provider
              end
            ...
            context 'Gcompute_target_pool[title2]' do
              subject do
                catalog.resource('Gcompute_target_pool[title2]').provider
              end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gcompute_target_pool[title0]').provider.ensure
          end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gcompute_target_pool[title0]')
              .provider.ensure
          end
  ...
  context '#flush' do
    subject do
      Puppet::Type.type(:gcompute_target_pool).new(
        ensure: :present,
        name: 'my-name'
      ).provider
    end
  ...
  context '#exports' do
    context 'exports all properties' do
      ...
      let(:expected_results) do
        {
          self_link: 'selflink(resource(target_pool,0))'
        }
      end
