...
describe Puppet::Type.type(:gcompute_firewall).provider(:google) do
        ...
        context 'title == name' do
          ...
          context 'title == name (pass)' do
            ...
            context 'Gcompute_firewall[title0]' do
              subject do
                catalog.resource('Gcompute_firewall[title0]').provider
              end
            ...
            context 'Gcompute_firewall[title1]' do
              subject do
                catalog.resource('Gcompute_firewall[title1]').provider
              end
            ...
            context 'Gcompute_firewall[title2]' do
              subject do
                catalog.resource('Gcompute_firewall[title2]').provider
              end
  ...
  context '#flush' do
    subject do
      Puppet::Type.type(:gcompute_firewall).new(
        ensure: :present,
        name: 'my-name'
      ).provider
    end
  ...
  def create_type(id)
    Puppet::Type.type(:gcompute_firewall).new(
      ...
      project: F_PROJECT_DATA[(id - 1) % F_PROJECT_DATA.size],
      name: F_NAME_DATA[(id - 1) % F_NAME_DATA.size]
    )
  end

  def expand_variables(template, data, extra_data = {})
    Puppet::Type.type(:gcompute_firewall).provider(:google)
