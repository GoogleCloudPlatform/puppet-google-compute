...
describe Puppet::Type.type(:gcompute_target_http_proxy).provider(:google) do
  before(:all) do
          ...
          context 'title == name (pass)' do
            ...
            let(:catalog) do
              apply_with_error_check(
                ...
                gcompute_target_http_proxy { 'title1':
                  ensure      => present,
                ...
                gcompute_target_http_proxy { 'title2':
                  ensure      => present,
            ...
            context 'Gcompute_target_http_proxy[title0]' do
              subject do
                catalog.resource('Gcompute_target_http_proxy[title0]').provider
              end
            ...
            context 'Gcompute_target_http_proxy[title1]' do
              subject do
                catalog.resource('Gcompute_target_http_proxy[title1]').provider
              end
            ...
            context 'Gcompute_target_http_proxy[title2]' do
              subject do
                catalog.resource('Gcompute_target_http_proxy[title2]').provider
              end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gcompute_target_http_proxy[title0]').provider.ensure
          end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gcompute_target_http_proxy[title0]')
              .provider.ensure
          end
  ...
  context '#flush' do
    subject do
      Puppet::Type.type(:gcompute_target_http_proxy).new(
        ensure: :present,
        name: 'my-name'
      ).provider
    end
  ...
  def expand_variables(template, data, extra_data = {})
    Puppet::Type.type(:gcompute_target_http_proxy).provider(:google)
